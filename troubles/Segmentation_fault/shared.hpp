...
public:
    ...
    /** Created in main() after sg4::Engine (never static sg4::Mutex::create before Engine). */
    static sg4::MutexPtr oclient_mutex;
    /** Serializes nfinished_dclients increments from data_client actors. */
    static sg4::MutexPtr dclient_nfinished_mutex;
};
